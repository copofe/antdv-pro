...
<template>
  <a href="https://gitee.com/antdv-pro/antdv-pro" target="_blank" hover="bg-[var(--hover-color)]" class="transition-all-300 flex items-center h-12 text-base cursor-pointer">
