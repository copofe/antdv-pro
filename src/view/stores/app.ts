...
import type { ContentWidth, LayoutType, ThemeType } from '::/view/layouts/basic-layout/typing'
import type { AnimationNameValueType } from '::/view/config/default-setting'
import defaultSetting from '::/view/config/default-setting'
