...
import ChartCard from '::/view/pages/dashboard/analysis/components/chart-card.vue'
import Field from '::/view/pages/dashboard/analysis/components/field.vue'
import Trend from '::/view/pages/dashboard/analysis/trend.vue'
